...
public class ConsultarRadicacionComunicacionController {
...
//	}
	...
	@RequestMapping(value = "/anonimas", method = RequestMethod.GET)
	public String ConsultaComunicacionAnonima(@ModelAttribute("TipoDocumento") TipoDocumento usuario, Model model) {
		RadicacionComunicacion radicacioncomunicacion = new RadicacionComunicacion();
